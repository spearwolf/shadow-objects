...
import {
  SHADOW_ELEMENT_ENTITY,
  SHADOW_ELEMENT_ENV,
  SHADOW_ELEMENT_ENV_LEGACY,
  SHADOW_ELEMENT_LOCAL_ENV,
...
Promise.all([
  customElements.whenDefined(SHADOW_ELEMENT_ENV),
  customElements.whenDefined(SHADOW_ELEMENT_ENV_LEGACY),
  customElements.whenDefined(SHADOW_ELEMENT_LOCAL_ENV),
]).then(() => {
