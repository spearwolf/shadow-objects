...
23. **Der `queueMicrotask` um `dispatchMessageToView` steht unbegründet da.** `Kernel.ts:591` stellt die `MessageToView`-Nachricht eine Microtask später zu, ohne Kommentar; dokumentiert in `docs/api-reference.md:2476`.
