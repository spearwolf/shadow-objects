...
> _Generated by [scripts/makeTODO.mjs](scripts/makeTODO.mjs) at 2024-05-26T10:20:36.750Z_
...
| [packages/shadow-ents/src/elements/ShadowWorker.ts](packages/shadow-ents/src/elements/ShadowWorker.ts#L291) | 291 | initialize worker ? |
| [packages/shadow-ents/src/elements/ShadowWorker.ts](packages/shadow-ents/src/elements/ShadowWorker.ts#L295) | 295 | this.actor.send({type: 'workerFailed'}) ? |
| [packages/shadow-ents/src/elements/ShadowWorker.ts](packages/shadow-ents/src/elements/ShadowWorker.ts#L307) | 307 | what should happen with the events ? |
| [packages/shadow-ents/src/elements/ShadowWorker.ts](packages/shadow-ents/src/elements/ShadowWorker.ts#L318) | 318 | find a more friendly way to destroy the worker before termination |
...
| Filename | line # | XXX |
|:------|:------:|:------|
| [packages/shadow-ents/src/elements/ShadowWorker.ts](packages/shadow-ents/src/elements/ShadowWorker.ts#L223) | 223 | do we really need to set additional properties on view component ? |
